...
export default function IngredientsBuilder() {
  ...
  useEffect(() => {
    ...
    // Removed automatic fallback to INGREDIENT_DICTIONARY to prevent data loss.
    // If no ingredients are loaded, the UI will remain empty and admins can manually add data.
    // Optionally, you can display a message prompting to create ingredients.
    // No timeout fallback is applied.

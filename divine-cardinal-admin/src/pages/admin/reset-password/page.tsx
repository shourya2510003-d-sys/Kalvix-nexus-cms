  ...
  if (!token || !email) {
    return (
      <div className="text-center py-6">
        ...
        <Link to="/admin/forgot-password" className="text-xs uppercase tracking-widest text-luxury-gold hover:text-black transition-colors font-medium">
    ...
    <div className="min-h-screen bg-luxury-cream flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div className="text-center flex flex-col items-center space-y-2">
          <Link to="/" className="font-serif text-3xl sm:text-4xl tracking-[0.2em] text-luxury-charcoal hover:opacity-90 transition-opacity">
            DIVINE CARDINAL
          </Link>
